    ...
    for epoch in range(cfg.epochs + 1):
        ...
        if cfg.local_rank == 0:
            ...
            if val_loss < best_loss:
                best_loss = val_loss
                torch.save(
                    (ema_model.module if ema_model else model).state_dict(),
                    f"best_model_{cfg.seed}.pt"
                )
...
"""torchrun --nproc_per_node=4 _train.py"""